#!/usr/bin/env bash
# Handles deep structure: content/category/mainfolder/foldername/filename.md
# Image saved to: static/notes/mainfolder/filename-N.webp
set -euo pipefail
...
# Derive paths
md_basename="$(basename "$ZED_FILE" .md)"
mainfolder="$(basename "$(dirname "$(dirname "$ZED_FILE")")")"
dest_dir="/home/abuturab/Documents/git/w3/w3-wiki/static/notes/${mainfolder}"

mkdir -p "$dest_dir"

base_name="${1:-${md_basename}}"
...
markdown_link="![](/notes/${mainfolder}/${file_name})"
